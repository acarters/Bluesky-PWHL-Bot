...
export default class Bot 
{
  ...
  */
    ...
    var bskyFeedAwait = await this.userAgent.app.bsky.feed.getAuthorFeed({actor: "notpwhl.bsky.social", limit: postNum,}); // Get a defined number + 2 of most recent posts from the logged in user's feed.
