...
export default async function getPostText() 
{
	...
	var awaitTweet = await mastodon.getStatuses("111840105532766992", {'limit':limitVal}); //Use the Mastodon API to get a specified number of recent posts from the Mastodon API.
